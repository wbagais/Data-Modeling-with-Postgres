...
def process_song_file(cur, filepath):
    """
    load data from song file and insert it into songs and artists tables
    Args:
        cur:psycopg2 cursor 
...
def process_log_file(cur, filepath):
    """
     load data from log file and insert it into users and songplays tables
     Args:
         cur:psycopg2 cursor 
         filepath: song file path
     Return: 
    ...
    time_df["start_time"] = df['ts'].values
...
def process_data(cur, conn, filepath, func):
    """
     Get the files pathes and iterate ofer the files and excute the function for each file
     Args:
         cur:psycopg2 cursor 
         conn: psycopg2 connection
         filepath: root directory for the files (song_data or log_data)
         func: function to be excuted for the list of files (process_song_file or process_log_file)
     Return: 
         NONE
     """
